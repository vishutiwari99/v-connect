        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <h2 className="mt-5 text-center text-3xl font-extrabold text-gray-900">Create an account</h2>
                </div>
                <form onSubmit={handleSubmit} className="mt-8 space-y-6"  >
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                onChange={handleChangeInput}
                            />
                            <span onClick={() => setCVisible(!cVisible)} className="absolute right-0 inset-y-0  flex items-center ">
                                {cVisible ? <EyeIcon className="h-5 w-10" /> : <EyeOffIcon className="h-5 w-10" />}
                            </span>
                        </div>
                        <div className="relative">
                            <div className="m-2">
                                <label className="inline-flex items-center ">
                                    <input type="radio" className="form-radio" id="male" name="gender"
                                        value="male" defaultChecked onChange={handleChangeInput} />
                                    <span className="ml-2">Male</span>
                                </label>
                                <label className="inline-flex items-center ml-6">
                                    <input type="radio" className="form-radio" id="female" name="gender"
                                        value="female" onChange={handleChangeInput} />
                                    <span className="ml-2">Female</span>
                                </label>
                                <label className="inline-flex items-center ml-6">
                                    <input type="radio" className="form-radio" id="other" name="gender"
                    ...
                    <div>
                        <button
                            ...
                            ${(!email || !password || !confirmPassword) ? "disabled:opacity-50 ..." : ""} 
                            `}
                        ...
                        <p className="mt-2 p-2">Already have an account ?
                            <Link to="/login">
